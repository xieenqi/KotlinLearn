...
public class ClearEditText2 extends AppCompatEditText implements
    ...
    private void init(Context context) {
        ...
        if (mClearDrawable == null) {
            /*几种取资源方法等价*/
            mClearDrawable = ResourcesCompat.getDrawable(getResources(), R.drawable.btn_delete, null);
//            ContextCompat.getDrawable(context, R.drawable.btn_delete);
//            getResources()
